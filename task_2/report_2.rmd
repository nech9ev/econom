...
after / before
```
Коэффициент 3 говорит о том, что выявлены значительные изменения в результате введения закона Макрона на 32 неделе для отелей Сардинии. Но эффект не совпадает с отелями Корсики, что подтверждает уникальность эффекта Корсики. Можем предположить что это конкурентная реакция отелей Сардинии в ответ на снижение цен на Корсике.
...
#Критерии подгонки
rmspe_list <- vector("list", length(all_controls))
...
Таким образом выявлена чувствительность к выбору контрольных единиц. Это может быть следствием недостатка наблюдений в контрольной группе которые похожи на тритмент-группу
